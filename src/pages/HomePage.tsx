...
const stats = [
  ...
  { label: 'Departments', value: departments.length, icon: Building2, color: 'bg-teal-500', bgColor: 'bg-teal-50' },
...
const quickLinks = [
  ...
  { to: '/departments', label: 'Departments', description: 'Academic departments overview', icon: Building2, color: 'text-teal-600' },
];
